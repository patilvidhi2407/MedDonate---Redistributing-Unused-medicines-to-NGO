...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $query1 = "INSERT INTO ngo_med_request1(NGOName, Email,Address, Medicine_name, Quantity,Description) VALUES ('$Name' , '$Email','$Address', '$Medicine_name', '$Quantity','$Description')";
